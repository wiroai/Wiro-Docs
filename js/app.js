...
const sections = [
  ...
  { slug: 'agent-overview', title: 'Agent Overview', description: 'Deploy and manage autonomous AI agents with the Wiro Agent API. Browse the agent catalog, deploy instances, configure credentials, and control agent lifecycle. Pricing model: tiers + tiermultiplier + per-action costs.' },
  ...
  { slug: 'agent-credentials', title: 'Agent Credentials & OAuth', description: 'Configure agent credentials via API keys or OAuth flows. Connect third-party services like Twitter, Google Ads, Meta Ads, HubSpot, and more. Browse the credential registry and audit credential edits.' },
  ...
  { slug: 'integration-metaads-skills', title: 'Meta Ads Integration', description: 'End-to-end setup for Meta Ads: Meta Developer App, OAuth, ad account selection via MetaAdsSetAdAccount. No App Review required in Development Mode + App Roles.' },
  { slug: 'integration-facebook-skills', title: 'Facebook Page Integration', description: 'Facebook Page publishing setup: OAuth with multi-page selection via FBSetPage, permissions, and Development Mode workflow.' },
  { slug: 'integration-instagram-skills', title: 'Instagram Integration', description: 'Instagram Business Account setup: Facebook Page linkage prerequisite, OAuth, content publishing permissions.' },
  ...
  { slug: 'integration-youtube-skills', title: 'YouTube Integration', description: 'YouTube Data API v3 + Analytics API v2 setup: channel listing, video assets for Google Ads Video/Demand Gen, channel picker via YTSetChannel.' },
  { slug: 'integration-ga4-skills', title: 'Google Analytics 4 Integration', description: 'Google Analytics 4 setup: GA4 Data API + Admin API, OAuth, property picker via GA4SetProperty for conversion reporting and attribution cross-checks.' },
  { slug: 'integration-merchantcenter-skills', title: 'Google Merchant Center Integration', description: 'Google Merchant Center (Shopping) setup: Merchant API v1, OAuth, merchant account picker via MCSetMerchantId, developer registration for own mode.' },
  ...
  { slug: 'voice-agent-twilio-channel', title: 'Twilio Voice Channel', description: 'Inbound phone call channel via Twilio Voice Webhooks + Media Streams. Account SID + Auth Token, auto-configured webhooks, hold media, max-duration timer. Used by Voice Receptionist agents.' },
