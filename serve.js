...
const sections = [
  ...
  { slug: 'integration-serper-search-skills', title: 'Google Web Search Integration', description: 'Real Google web-search results as clean JSON via Serper.dev — title/link/snippet for research before writing, then fetch the top pages. One API key, no Google Cloud project or cx. Used by content and marketing agents.' },
