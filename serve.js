...
const sections = [
  ...
  { slug: 'integration-metaads-skills', title: 'Meta Ads Integration', description: 'End-to-end setup for Meta Ads: Meta Developer App, unified OAuth flow, ad account selection via SetPickerAccounts. No App Review required in Development Mode + App Roles.' },
  { slug: 'integration-facebook-skills', title: 'Facebook Page Integration', description: 'Facebook Page publishing setup: unified OAuth flow with multi-page selection via SetPickerAccounts, permissions, and Development Mode workflow.' },
