...
const sections = [
  ...
  { slug: 'integration-googledrive-skills', title: 'Google Drive Integration', description: 'Google Drive folder-scoped access via drive.file OAuth scope. Select specific folders for agent read/write.' },
