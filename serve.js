...
const sections = [
  ...
  { slug: 'integration-google-search-skills', title: 'Google Web Search Integration', description: 'Operator-supplied Google API key + Programmable Search Engine (cx). Real open-web search via the Custom Search JSON API — clean title/link/snippet results for research before writing. Used by content and marketing agents.' },
