...
35. [TikTok Ads Integration](#tiktok-ads-integration)
36. [Facebook Page Integration](#facebook-page-integration)
37. [Instagram Integration](#instagram-integration)
38. [Shopify Integration](#shopify-integration)
39. [WooCommerce Integration](#woocommerce-integration)
40. [Reddit Integration](#reddit-integration)
41. [Organizations & Teams](#organizations--teams)
42. [Managing Teams](#managing-teams)
43. [Team Billing & Spending](#team-billing--spending)
44. [Team API Access](#team-api-access)
45. [Telegram Integration](#telegram-integration)
...
or Anthropic LLM protocols, see the
...
8. **Switching models** — open on another model for one session:
   ...
   scope then opens on. Move `CLAUDE_CODE_MAX_CONTEXT_TOKENS` with it — Grok 4.1
   Fast holds 2M where GPT 5.6 Sol holds 1.05M:
...
- The [Direct LLM Gateway](#direct-llm-gateway) offers OpenAI Chat/Responses and Anthropic Messages on `llm.wiro.ai`.
...
| `0` | This model is not available for your team | Use a model your team allows |
